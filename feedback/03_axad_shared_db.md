...
```json
{
  "mcpServers": {
    "axad": {
      "command": "npx",
      "args": ["-y", "@modelcontextprotocol/server-postgres", "postgresql://kiguchi:axad_readonly_2026@ep-frosty-mountain-a1l9h522-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require"]
    }
  }
}
```
